...
//Код для верхнего списка//

let features = document.querySelectorAll('.item_feature');
...
let CloseBlurred = document.querySelector('.main_content_site.blurred')
...
mainCont1.addEventListener('click', function(){
navCont.classList.remove('active')
  mainCont2.classList.remove('blurred')
})
